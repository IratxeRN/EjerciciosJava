...
/**
 * Interfaz para obligar a implementar una serie de metodos. /** Una interfaz ()
 * es sintácticamente similar a una clase abstracta, en la que puede especificar
 * uno o más métodos que no tienen cuerpo ({}).Esos métodos deben ser
 * implementados por una clase para que se definan sus acciones.<br>
 * 
...
public interface IFunciones {
	...
	/**
	 * imprime los numeros de la Loteria Elegir el numero de loteria que quieres.
	 * 
	 * @param tipo loteria esta definido en las constantes.
