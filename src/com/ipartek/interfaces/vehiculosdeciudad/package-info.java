 ...
 * apagándose. <br>
 * El proceso deberá seguir la lógica del mundo real. No se podrá apagar si ya
 * está encendido, no podrá acelerar ni frenar si esta apagado… realizar las
 * modificaciones pertinentes en el programa para que los atributos arrancado y
 * velocidadActual se hereden de una clase vehiculo, y que no se pueda heredar
 * de las clases patinete bici y coche
 * 
 * 
 */
package com.ipartek.interfaces.vehiculosdeciudad;